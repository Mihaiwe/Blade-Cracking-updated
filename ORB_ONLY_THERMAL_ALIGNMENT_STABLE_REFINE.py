...
output_folder = base_folder / "alignment_outputs_thermal_orb_stable_refine_updated"
...
BEFORE_THERMAL_CROP_H = 360  # total height of the remaining image after crop

AFTER_THERMAL_CROP_X = 0
AFTER_THERMAL_CROP_Y = 84
AFTER_THERMAL_CROP_W = 640
AFTER_THERMAL_CROP_H = 360
